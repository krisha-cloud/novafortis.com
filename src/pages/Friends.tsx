...
import { UserPlus, Users, Search, Copy, Check, X, Crown, Flame, MessageCircle } from "lucide-react";
import { useToast } from "@/hooks/use-toast";
import { Friend, mockFriends, statusColors, statusLabels } from "@/components/friends/FriendTypes";
import GroupChat from "@/components/friends/GroupChat";
...
const Friends = () => {
  ...
  const tabs = [
    ...
    { id: "chat" as const, label: "Group Chat", icon: MessageCircle },
  ];
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Tabs */}
      <div className="flex gap-1 p-1 rounded-xl bg-secondary/30 w-fit">
        {tabs.map((tab) => (
          <button
            key={tab.id}
